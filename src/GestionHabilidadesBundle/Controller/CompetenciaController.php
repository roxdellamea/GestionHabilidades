...
use GestionHabilidadesBundle\Entity\Competencia;
use GestionHabilidadesBundle\Form\CompetenciaType;
...
class CompetenciaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GestionHabilidadesBundle:Competencia')->findAll();

        return $this->render('GestionHabilidadesBundle:Competencia:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('competencia_new', array('id' => $entity->getId())));
        }

        return $this->render('GestionHabilidadesBundle:Competencia:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GestionHabilidadesBundle:Competencia')->find($id);
        ...
        return $this->render('GestionHabilidadesBundle:Competencia:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('GestionHabilidadesBundle:Competencia:edit.html.twig', array(
            'entity'      => $entity,
